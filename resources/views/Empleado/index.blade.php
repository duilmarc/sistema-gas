    ...
    <form method="POST" action="/empleados">
        ...
        <div class="form-row align-items-center">
          ...
          <div class="col-auto">
            ...
            <input type="text" name="nombres" class="form-control mb-2" id="inlineFormInput" placeholder="nombres">
          </div>
          <div class="col-auto">
            <label class="sr-only" for="inlineFormInputGroup">Salario</label>
            <div class="input-group mb-2">
              <input type="text" name="salario" class="form-control" id="inlineFormInputGroup" placeholder="Salario">
            </div>
          </div>
          <div class="col-auto">
