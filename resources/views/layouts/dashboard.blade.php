...
<head>
  ...
  <link href="{{ asset('css/fuentes/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/home') }}">
          <img src="{{ asset('img/gas_icon.png') }}" class="img-fluid" style="max-width: 60%;">
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">  
            <a class="collapse-item" href="{{ url('/ventas') }}">Iniciar Día</a>
            <a class="collapse-item" href="{{ url('/ventas/realizadas') }}">Ventas Realizadas</a>
            <a class="collapse-item" href="{{ url('/ventas/canceladas') }}">Ventas Canceladas</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="{{ url('/clientes') }}">Registrar/Ver clientes</a>
               <!--<a class="collapse-item" href="{{ url('/clientes/balones_prestados') }}">Ver balones prestados</a> -->
          </div>
        </div>
      </li>
            <!-- Divider -->
    ...
    <script src="{{ asset('css/fuentes/jquery-easing/jquery.easing.min.js') }}"></script>
